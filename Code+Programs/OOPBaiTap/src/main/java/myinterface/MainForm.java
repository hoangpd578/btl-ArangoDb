...
public class MainForm extends javax.swing.JFrame {
    ...
    public static ServerConnection databaseConnecter = ServerConnection.getServerConnecter(host, port, user, password);
    ...
    private void queryRunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_queryRunActionPerformed
        ...
        resultQuery.setText("");
        ArangoDatabase conn = null;

        if (comboChooseDB.getSelectedIndex() == 0) {
            conn = databaseConnecter.getDatatabase("testdatabase100");
        } else if (comboChooseDB.getSelectedIndex() == 1) {
            conn = databaseConnecter.getDatatabase("testdatabase5000");
        } else if (comboChooseDB.getSelectedIndex() == 2) {
            conn = databaseConnecter.getDatatabase("testdatabase60000");
        } else if (comboChooseDB.getSelectedIndex() == 3) {
            conn = databaseConnecter.getDatatabase("testdatabase100000");
        } else if (comboChooseDB.getSelectedIndex() == 4) {
            conn = databaseConnecter.getDatatabase("testdatabase500000");
        }
